...
class WorkOutHolidayShiftsPage {
    ...
    async checkPageLoads(page: Page): Promise<void> {
        await Promise.all([
            expect(page.locator(this.title)).toHaveText(workOutHoliday_content.pageTitleShifts),
    ...
    async continueOnPartway(page: Page): Promise<void> {
...
export default WorkOutHolidayShiftsPage;
